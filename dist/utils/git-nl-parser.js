...
exports.parseGitIntent = parseGitIntent;
exports.parseGitIntentWithLlm = parseGitIntentWithLlm;
exports.getGitCommandHelp = getGitCommandHelp;
...
const RULES = [
    ...
    // Commit with message
    {
        ...
        extract: (match, raw) => {
            ...
            const isAll = /^(?:git\s+)?commit\s+-a\s/i.test(raw) ||
 ...
 */
async function parseGitIntentWithLlm(input) {
    // First try rules
