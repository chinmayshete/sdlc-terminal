...
export function getSecurityCommandHelp(): string[] {
  return [
    ...
    "  rules                Show all scan rules",
    "",
    "── Secret Detection ──",
    "  secrets              Check for hardcoded secrets",
    "  env audit            Audit .env file security",
    "  sensitive fields     Show config fields that need Vault",
    "",
    "── Dependency Security ──",
    "  audit / deps audit   Run npm vulnerability audit",
    "  licenses             License compliance check",
    "",
    "── Vault & Config ──",
    "  vault                Vault integration status",
    "  config security      Validate config security",
    "",
    "── Compliance & Policy ──",
    "  compliance           Full compliance check",
    "  gitflow              Show GitFlow policy guide",
    "  codeowners           Show code ownership rules",
    "",
    "── Infrastructure ──",
    "  docker security      Docker security assessment",
    "  terraform security   Terraform security assessment",
    "",
    "── Dashboard ──",
    "  dashboard            Full security dashboard",
